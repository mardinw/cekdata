...
export const excelUpload = async (ctx) => {
...
export const listFileExcel = async (ctx) => {
    // cek uuid yang login
    const uuid = ctx.get('uuid');
    try {
...
export const previewFileExcel = async (ctx) => {
...
export const exportMatchToExcel = async (ctx) => {
...
export const downloadSample = async (ctx) => {
    // cek uuid yang login
    const uuid = ctx.get('uuid');
    if (!uuid) {
